...
public class Main {
    ...
    public static void main(String[] args) {
        /*
         * con: if two clients called getInstance() in the same timestamp to the millisecond,
         * two different instances will be created. To solve this, use thread safe instantiation.
         */
